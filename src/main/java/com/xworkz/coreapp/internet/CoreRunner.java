...
import com.xworkz.coreapp.airport.CoreConfigure;
...
//        Integer integer1 = (Integer) applicationContext.getBean("theNameGivenAtBean" );
...
//
//        List<String> list = applicationContext.getBean(List.class);
