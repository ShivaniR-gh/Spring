    ...
    <div class="row w-100 align-items-center">
        ...
        <div class="col-md-6 left-panel">
            ...
            <p class="mt-3 text-muted fs-5">
                Master backend, frontend, and database technologies
            ...
            <!-- OPTIONAL IMAGE
            <img src="${pageContext.request.contextPath}/dev.png"
        ...
        <div class="col-md-6 right-panel text-center">
            <h1 class="fw-bold">Welcome to Xworkz</h1>
            <p class="fs-5 text-muted mt-3">
                Learn  Build  Grow your career with confidence
            </p>
        </div>
